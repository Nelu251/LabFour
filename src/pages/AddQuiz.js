            ...
            <div className="Form">
                <div className="card">
                    <div className="card-body">
                        <h1 className="card-title">Create New Quiz</h1>
                                    ...
                                    return (
                                        <div key={index}>
                                            ...
                                            <input type="text" className="form-control" name="question"
                                                   ...
                                                   value={form.question}/> <br/>

                                            <label htmlFor="answer[0]" className="form-label">Answer 1</label>
                                            <input type="text" className="form-control" name="answers[0]"
                                                   onChange={event => handleFormChange(event, index)}
                                                   value={form.answers[0]}/> <br/>

                                            <label htmlFor="answer[1]" className="form-label">Answer 2</label>
                                            <input type="text" className="form-control" name="answers[1]"
                                                   onChange={event => handleFormChange(event, index)}
                                                   value={form.answers[1]}/> <br/>

                                            <label htmlFor="answer[2]" className="form-label">Answer 3</label>
                                            <input type="text" className="form-control" name="answers[2]"
                                                   onChange={event => handleFormChange(event, index)}
                                                   value={form.answers[2]}/> <br/>

                                            <label htmlFor="answer[3]" className="form-label">Answer 4</label> <br/>
                                            <input type="text" className="form-control" name="answers[3]"
                                                   onChange={event => handleFormChange(event, index)}
                                                   value={form.answers[3]}/> <br/>

                                            <label htmlFor="correct_answer" className="form-label">Select the correct
                                                answer:</label> <br/>
                                            <select name="correct_answer" className="form-control"
                                            ...
                                            <button className="btn btn-danger mb-3"
                                                    onClick={() => removeFields(index)}>Remove One Question
                                            </button>
                                        </div>
                                    )
                                })
                        ...
                        <button className="btn btn-dark mb-3" onClick={addFields}>Add One More Question</button>
                        <br/>
